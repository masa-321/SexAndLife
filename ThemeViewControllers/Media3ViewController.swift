...
//
//class Media3ViewController: UIViewController, UITableViewDelegate, UITableViewDataSource{
//    //TableViewの宣言
...
//            let ref = Firestore.firestore().collection("articleData").whereField("genreName", isEqualTo: "避妊のこと")
//            let uid = user.uid
//            
...
//                    
//                    if self.articleArray.count < 30 && articleData.genreName == "避妊のこと"{ //トップ記事は30記事まで
...
//                    if articleData.genreName == "避妊のこと"{ //トップ記事は30記事まで
...
//                            self.articleArray.insert(articleData, at:index)
//                        }
//                    }*///articleDataとarticleArrayの配列が異なるやつはこういう一工夫が必要と思われる。
//                    
//                    
//                    let before = self.tableView.contentOffset.y
//                    self.tableView.reloadData()
